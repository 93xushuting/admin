...
export default {
  data () {
    return {
      // phone: '15216763787'
      // 获取手机号条件：1:4G，2:必须是创蓝后台发出的短信
      // 地址:https://p.unijobox.com/officialwebLink?encryChar=xxhT9xS_ajqLX&encryType=2&phone=null
      keys: '',
      phone: ''
    }
  },
  created () {
  ...
  mounted () {
    ...
    this.$nextTick(() => {
      this.loadScript('https://cdn.bootcss.com/jsencrypt/3.0.0-beta.1/jsencrypt.js', () => {
  ...
  methods: {
        ...
        if (pair[0] === variable) {
          ...
          if (p && p.length > 11) {
            try {
              ...
              encrypt.setPrivateKey(this.keys)
              p = encrypt.decrypt(decodeURIComponent(p))
            } catch (e) {
              return p
            }
          }
    ...
    setUrl (flag) {
      // alert(`7 - flag - :${flag}`)
      // let query = flag ? `phone=${this.phone}&phoneLinkId=1508277921897385984` : 'phoneLinkId=1508277921897385984' // dev -- phoneLinkId
      // let query = flag ? `phone=${this.phone}&phoneLinkId=1508275735746449408` : 'phoneLinkId=1508275735746449408' // pre -- phoneLinkId
      // let query = flag ? `phone=${this.phone}&phoneLinkId=1508418821189423104` : 'phoneLinkId=1508418821189423104' //pro -- phoneLinkId
      // let path = 'pagesA/pages/banner/position_link'
      let query = `phone=${this.phone}&phoneLinkId=1508418821189423104`
      let path = 'pages/home/home/home'
      axios({
        method: 'POST',
        // pagesA/pages/tempList/tempList
